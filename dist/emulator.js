...
class CPU {
    ...
    resetBitInstruction(value, bit) {
        const updated = this.clearBit(value, 0);
        this.PC += 2;
        return updated;
    }
    resetHLBitInstruction(bit) {
        const value = this.bus.readByte(this.HL);
